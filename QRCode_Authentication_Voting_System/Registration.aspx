<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="FingerPrint_Voting_Systen.Registration" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="jumbotron jumbotron-fluid j">
            <div class="container">
                ...
                <p class="lead"><h2>VOTER REGISTRATION FORM</h2></p>
                <br />
                <br />
            </div>
        </div>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:TextBox ID="TextBox4" runat="server" OnTextChanged="TextBox2_TextChanged" Width="150px" TextMode="Number"></asp:TextBox>
        <br />
        <br />
        &nbsp;<asp:Label ID="Label3" runat="server" Text="DOB"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox2_TextChanged" Width="150px" TextMode="Date"></asp:TextBox>
        <br />
        <br />
        &nbsp;<asp:Label ID="Label6" runat="server" Text="ADDRESS"></asp:Label>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox6" runat="server" OnTextChanged="TextBox2_TextChanged" Width="150px"></asp:TextBox>
        <br />
        <br />
        &nbsp;<asp:Label ID="Label5" runat="server" Text="AGE" Visible="false"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        <asp:TextBox ID="TextBox5" runat="server" OnTextChanged="TextBox2_TextChanged" Width="150px" TextMode="Number" Visible="false"></asp:TextBox>
        <br />
        <br />
